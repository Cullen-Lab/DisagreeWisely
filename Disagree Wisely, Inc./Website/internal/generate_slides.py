...
story.append(bullet("$150K prize. $25K spent (Instructor Insights \u2014 complete). ~$125K remains for ChatMaps."))
story.append(bullet("Funds can no longer be compliantly spent through DW"))
story.append(bullet("Plan: <b>return ~$125K</b> to Learning Agency for redirection to PBC or Simon/Nick personally"))
story.append(bullet("Met Kristyn Manoukian (March 2) \u2014 receptive, no major concerns. Coordinating with Digital Harbor Foundation."))
story.append(Spacer(1, 6))
